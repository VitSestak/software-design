...
public class UserActivityController {
    ...
    public List<ChallengeStatusDto> getAcceptedChallengesStatus(long token) {
        try {
            return serviceLocator.getService().getChallengesStatus(token);
        } catch (RemoteException e) {
            log.severe("Error when getting challenge statuses: " + e);
        }
        return List.of();
    }
}
